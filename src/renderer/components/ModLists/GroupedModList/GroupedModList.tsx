...
/** A wrapper around the {@link RawModList} component, used to add buttons like
 * add all and remove all for a group of mods.
 */
const GroupedModList = ({ icon, title, mods }: ModListProps) => {
    ...
    return (
        <Accordion expanded={isExpanded} onChange={() => setIsExpanded(!isExpanded)} disableGutters>
            ...
            <AccordionDetails>
                <RawModList mods={mods} />
            </AccordionDetails>
        </Accordion>
    );
};

export default GroupedModList;
